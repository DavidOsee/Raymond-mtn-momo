...
const sendRequestTopay = async (transaction_data, request_id) =>{
  ...
  let config = {
    ...
    headers: { 
      ...
      // 'X-Callback-Url': 'http://localhost:8000/api/payment-status', 
...
const sendPaymentStatusRequest = async (request_id) =>{
